...
Feature: Test Risk Malus RabbitMQ
  ...
  @tag1
  Scenario: Publish Message for Risk Malus First Installment Monthly Bonus with RabbitMQ. CN:4000012032
    Given Connect Database Commision Engine
    Given Select from CE_MASTER_DATA "SELECT * FROM CE_MASTER_DATA WHERE CONTRACT_NUMBER='4000012032'"
