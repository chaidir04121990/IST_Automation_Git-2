...
@tag
Feature: Contract Dispatcher for WCF Paperless
  I want to use this template for my feature file

  @tag1
  Scenario: Select Menu Contract Dispatcher and Select Contract based on type contract WCF Paperless
    Given Go to IST
    ...
    And Select Contract Number based on Type Contract "WCF_PAPERLESS"
