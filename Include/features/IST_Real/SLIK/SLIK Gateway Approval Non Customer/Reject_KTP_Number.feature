...
Feature: Title of your feature
  ...
  @tag1
  Scenario: Reject KTP Number by Checker
    Given Go to ISTools
    ...
    And Click button "Reject"
    And Get text from pop up "Confirmation Submit Request" with text "Are you sure to Reject this data ?"
    And Click button "Yes"
    And Get text from pop up "IT Supporting Tools" with text "1 data successfully rejected"
    And Click button "OK"
    And Close browser