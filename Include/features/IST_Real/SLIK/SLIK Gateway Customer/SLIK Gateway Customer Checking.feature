...
@tag
Feature: SLIK Checking Customer
  I want to use this template for my feature file

  Scenario: SLIK Gateway Customer Checking
    Given Go to ISTools
    ...
    And Input Date of Birth "20-Feb-1990"
  ...
  #Given Connect to Database
    #And Check KTP Number in Slik DB "SELECT * FROM SLIK_DATA_CUSTOMER WHERE KTP="
    #And Check KTP Number in Slik DB "SELECT * FROM SLIK_DATA_CUSTOMER WHERE KTP='0101501422900015' AND TYPE='C'" 
