...
@tag
Feature: Two Wheelers Doesn't Exist in Contract Dispatcher menu for type contract TWO WHEELERS EFP
  I want to use this template for my feature file

  @tag1
  Scenario: Go to Menu Contract Dispatcher to select type contract Two Wheelers EFP but it doesn't exist
    Given Go to IST
