...
@tag
Feature: Pick Mistake Without Write Textarea Note-Before BPKB
  ...
  Scenario: Assign User to Contract BPKB
    ...
    And Choose Dropdown mistake type "Dokumen diunggah tidak ada" from mistake name "BPKB bagian depan tidak ada"
