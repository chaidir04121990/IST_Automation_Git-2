...
@tag
Feature: Contract with Type BPKB Doesn't Exist in Contract Dispatcher Menu
  I want to use this template for my feature file

  @tag1
  Scenario: Go to Menu Contract Dispatcher to select type contract BPKB but it doesn't exist
    Given Go to IST
    ...
    And Comment "Type Contract BPKB Does Not Exist"
