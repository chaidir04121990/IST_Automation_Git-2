...
@tag
Feature: Contract Dispatcher for DONA_BUKALAPAK
  I want to use this template for my feature file

  @tag1
  Scenario: Assign User to Contract Dona eWallet
    Given Go to IST
    ...
    Scenario: Select Menu Contract Dispatcher and Select Contract based on type contract DONA_BUKALAPAK
    Given Go to IST
    When Login IST with valid credentials
      | username    | password                 |
      | mobile.test | heMxIzEAyQpycx257HePHg== |
