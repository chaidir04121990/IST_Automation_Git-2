...
@tag
Feature: Search by STATUS for Partner Disbursement SBO
  ...
  Scenario: Search by STATUS Eligible to Disburse
    ...
    And Select Menu "Partner Disbursement SBO"
    ...
    Scenario: Search by STATUS Waiting validation from Risk
    Given Go to ISTools
    When Login IST with valid credentials
      | username    | password                 |
      | mobile.test | heMxIzEAyQpycx257HePHg== |
    ...
    And Select Arrow Menu "Real Time Disbursement"
    And Select Menu "Partner Disbursement SBO"
    And Select STATUS "Waiting validation from Risk"
    And Click button "Search"
    And Verify Search Result Presents
    And Click button "Logout"
    And Close browser
    
    Scenario: Search by STATUS Waiting validation from In Payment
    Given Go to ISTools
    When Login IST with valid credentials
      | username    | password                 |
      | mobile.test | heMxIzEAyQpycx257HePHg== |
    ...
    And Select Arrow Menu "Real Time Disbursement"
    And Select Menu "Partner Disbursement SBO"
    And Select STATUS "Waiting validation from In Payment"
    And Click button "Search"
    And Verify Search Result Presents
    And Click button "Logout"
    And Close browser
    ...
    Scenario: Search by STATUS Hold Payment Recreation
    Given Go to ISTools
    When Login IST with valid credentials
      | username    | password                 |
      | mobile.test | heMxIzEAyQpycx257HePHg== |
    ...
    And Select Arrow Menu "Real Time Disbursement"
    And Select Menu "Partner Disbursement SBO"
    And Select STATUS "Hold Payment Recreation"
    And Click button "Search"
    And Verify Search Result Presents
    And Click button "Logout"
    And Close browser
    
    Scenario: Search by STATUS Waiting Confirmation From SBO
    Given Go to ISTools
    When Login IST with valid credentials
      | username    | password                 |
      | mobile.test | heMxIzEAyQpycx257HePHg== |
    ...
    And Select Arrow Menu "Real Time Disbursement"
    And Select Menu "Partner Disbursement SBO"
    And Select STATUS "Waiting Confirmation From SBO"
    And Click button "Search"
    And Verify Search Result Presents
    And Click button "Logout"
    And Close browser
    
    Scenario: Search by STATUS Hold Payment Insufficient Fund
    Given Go to ISTools
    When Login IST with valid credentials
      | username    | password                 |
      | mobile.test | heMxIzEAyQpycx257HePHg== |
    ...
    And Select Arrow Menu "Real Time Disbursement"
    And Select Menu "Partner Disbursement SBO"
    And Select STATUS "Hold Payment Insufficient Fund"
    And Click button "Search"
    And Verify Search Result Presents
    And Click button "Logout"
    And Close browser