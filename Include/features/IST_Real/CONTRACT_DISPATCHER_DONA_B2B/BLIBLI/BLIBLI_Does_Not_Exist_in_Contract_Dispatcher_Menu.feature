...
@tag
Feature: Dona BliBli Doesn't Exist in Contract Dispatcher menu
  I want to use this template for my feature file

  @tag1
  Scenario: Go to Menu Contract Dispatcher to select type contract Dona BliBli but it doesn't exist
    Given Go to IST
    ...
    And Comment "Type Contract DONA BliBli Does Not Exist" 
    And Close browser