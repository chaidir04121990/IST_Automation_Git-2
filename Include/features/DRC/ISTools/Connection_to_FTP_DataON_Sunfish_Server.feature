...
@tag
Feature: Connection to FTP DataON Sunfish Server
  I want to use this template for my feature file

  @tag1
  Scenario: Connection to FTP DataON Sunfish Server by Hit Batch Scan HRIS
    ...
    When Login IST with valid credentials
      ...
      And Select Menu "Batch New Employee"
