$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/DRC/IST_Tracker/Connection_to_Database.feature");
formatter.feature({
  "name": "Connection to Database IST Tracker",
...
formatter.scenario({
  "name": "Select Menu Management Assignment to give assign contract PAPERLESS POS",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "Check for username if already assigned to \"Regular\"",
  "keyword": "And "
});
formatter.match({
...
formatter.scenario({
  "name": "Connection to Database IST Tracker with Search data from menu(Contract Dispatcher)",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "Select Contract Number based on Type Contract \"REGULAR POS\"",
  "keyword": "And "
});
formatter.match({
