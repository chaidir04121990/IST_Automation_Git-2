$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/RTD/Hold Payment Configuration/Date_is_NULL.feature");
formatter.feature({
  "name": "Hold Payment Configuration Date is Null",
...
formatter.step({
  "name": "Input \"Start Date Hold Payment\" with value \"\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "Get text from pop up \"IT Supporting Tools\" with text \"Start date \u0026 end date cannot be empty\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "Input \"Release Date\" with value \"\"",
  "keyword": "And "
});
formatter.match({
  "location": "RTD.Input_(String,String)"
