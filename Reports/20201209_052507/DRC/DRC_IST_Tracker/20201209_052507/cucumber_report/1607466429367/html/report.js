...
formatter.step({
  "name": "Type on Textbox label \"Contract Number\" with value \"4003378179\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "Verify Table Exist",
  "keyword": "And "
});
formatter.match({
  "location": "Contract_Dispatcher.hardcopyjournettwtable()"
});
formatter.result({
  "status": "passed"
});
