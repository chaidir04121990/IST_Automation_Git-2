$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/RTD/Dashboard_for_CCC_OCS/Search_by_Contract_Number_CCC_OCS.feature");
formatter.feature({
  "name": "Search Contract Number for Dashboard for CCC/OCS",
...
formatter.step({
  "name": "Select Menu \"Dashboard for CCC/OCS\"",
  "keyword": "And "
});
formatter.match({
