$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/RTD/Disbursement_Dashboard/Search_by_STATUS_Disbursement_Dashboard.feature");
formatter.feature({
  "name": "Search by STATUS for Disbursement Dashboard",
...
formatter.scenario({
  "name": "Search by STATUS Waiting approval from Risk",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "Select STATUS \"Waiting approval from Risk\"",
  "keyword": "And "
});
formatter.match({
  "location": "RTD.Select_STATUS(String)"
...
formatter.scenario({
  "name": "Search by STATUS Waiting for approval from In Payment",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "Select STATUS \"Waiting for approval from In Payment\"",
  "keyword": "And "
});
formatter.match({
  "location": "RTD.Select_STATUS(String)"
