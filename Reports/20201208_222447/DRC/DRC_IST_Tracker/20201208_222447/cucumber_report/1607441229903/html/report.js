$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/DRC/IST_Tracker/Send_Email.feature");
formatter.feature({
...
formatter.step({
  "name": "Type EmailClient on \"Alamat Email yang digunakan client\" with value \"chaidir04121990@yahoo.co.id\"",
  "keyword": "And "
});
formatter.match({
