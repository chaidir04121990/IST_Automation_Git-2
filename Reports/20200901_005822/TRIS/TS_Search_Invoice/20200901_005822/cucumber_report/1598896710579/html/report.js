$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/TRIS/Search_Invoice.feature");
formatter.feature({
...
formatter.step({
  "name": "Type on Textbox label \"contract number of email address\" with invoice number",
  "keyword": "And "
});
formatter.match({
  "location": "Contract_Dispatcher.FillInvoiceNumber(String)"
});
formatter.result({
  "status": "passed"
});
