$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/SLIK/SLIK Bulk Request MPF/SLIK Bulk Request MPF_NORMAL.feature");
formatter.feature({
  "name": "SLIK Bulk Request MPF",
...
formatter.step({
  "name": "Select Menu \"SLIK Bulk Request MPF\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "Upload file \"Template Bulk Request MPF.csv\"",
  "keyword": "And "
});
formatter.match({
