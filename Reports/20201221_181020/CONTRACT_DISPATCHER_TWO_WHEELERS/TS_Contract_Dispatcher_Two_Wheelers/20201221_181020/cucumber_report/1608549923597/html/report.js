$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_TWO_WHEELERS/Two_Wheelers_Does_Not_Exist_in_Contract_Dispatcher_Menu.feature");
formatter.feature({
  "name": "Two Wheelers Doesn\u0027t Exist in Contract Dispatcher menu",
...
formatter.step({
  "name": "Comment \"Type Contract Two Wheelers Does Not Exist\"",
  "keyword": "And "
});
formatter.match({
