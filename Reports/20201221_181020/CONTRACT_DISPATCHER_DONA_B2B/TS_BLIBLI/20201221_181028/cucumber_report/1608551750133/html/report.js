$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_DONA_B2B/BLIBLI/Claim_Contract_BLIBLI_then_Save_it_Without_Register_Any_Mistakes.feature");
formatter.feature({
  "name": "Claim Contract Dona BliBli then Save it Without Register any Mistakes",
