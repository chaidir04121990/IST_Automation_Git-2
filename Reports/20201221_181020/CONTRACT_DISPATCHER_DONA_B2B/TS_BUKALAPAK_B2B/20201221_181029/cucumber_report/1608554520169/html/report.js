$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_DONA_B2B/BUKALAPAK/Column_PROCESSED_Turn_N_When_Status_RELEASE_BUKALAPAK_B2B.feature");
formatter.feature({
...
formatter.scenario({
  "name": "Claim Contract DONA Bukalapak B2B in Contract Dispatcher Menu then idle for 10 minutes, STATUS in Table CONTRACT_DISPATCHER_CLAIM turn RELEASE and PROCESSED in CONTRACT_DISPATCHER_SOURCE turns N",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "Exec Query idle for Ten Minutes \"SELECT * FROM CONTRACT_DISPATCHER_SOURCE WHERE TEXT_CONTRACT_NUMBER\u003d\u0027337\u0027\"",
  "keyword": "And "
});
formatter.match({
