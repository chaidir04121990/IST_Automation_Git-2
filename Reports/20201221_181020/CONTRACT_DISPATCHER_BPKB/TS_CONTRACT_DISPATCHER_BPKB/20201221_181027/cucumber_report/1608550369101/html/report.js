$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_BPKB/Contract_Dispatcher_BPKB.feature");
formatter.feature({
  "name": "Contract Dispatcher BPKB",
...
formatter.scenario({
  "name": "Select Contract Dispatcher Menu based on type contract BPKB",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "Choose Dropdown mistake type \"Dokumen diunggah tidak ada\" from mistake name \"01. BPKB bagian depan tidak ada\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "Type on textarea note before based on mistake name \"01. BPKB bagian depan tidak ada\" with value \"TESTING\"",
  "keyword": "And "
});
formatter.match({
