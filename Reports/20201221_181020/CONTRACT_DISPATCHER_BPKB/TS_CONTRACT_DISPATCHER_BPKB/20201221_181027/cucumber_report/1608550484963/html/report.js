$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_BPKB/PIck_Mistake_Without_Write_Textarea_Note_Before.feature");
formatter.feature({
  "name": "Pick Mistake Without Write Textarea Note-Before BPKB",
...
formatter.step({
  "name": "Checkbox General Mistake \"01. BPKB bagian depan tidak ada\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "Choose Dropdown mistake type \"Dokumen diunggah tidak ada\" from mistake name \"BPKB bagian depan tidak ada\"",
  "keyword": "And "
});
formatter.match({
