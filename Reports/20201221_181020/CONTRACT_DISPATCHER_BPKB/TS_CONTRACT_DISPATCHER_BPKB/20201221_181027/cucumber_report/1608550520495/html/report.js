$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_BPKB/Pick_Mistake_Without_Write_Textarea_Note_After.feature");
formatter.feature({
  "name": "Pick Mistake Without Write Textarea Note-After BPKB",
...
formatter.step({
  "name": "Checkbox General Mistake \"05. Data nomor rangka dan nomor mesin di BPKB berbeda dengan Surat Nomor Rangka dan Mesin Gesek Kendaraan\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "Choose Dropdown mistake type \"No rangka berbeda (BPKB vs Surat gesek no rangka)\" from mistake name \"Data nomor rangka dan nomor mesin di BPKB berbeda dengan Surat Nomor Rangka dan Mesin Gesek Kendaraan\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "Type on textarea note before based on mistake name \"Data nomor rangka dan nomor mesin di BPKB berbeda dengan Surat Nomor Rangka dan Mesin Gesek Kendaraan\" with value \"TESTING\"",
  "keyword": "And "
});
formatter.match({
