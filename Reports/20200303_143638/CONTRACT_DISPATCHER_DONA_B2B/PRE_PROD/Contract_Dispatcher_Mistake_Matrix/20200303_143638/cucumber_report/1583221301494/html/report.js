...
formatter.step({
  "name": "Get text from pop up \"IT Supporting Tools\" with text \"Contract will be REGISTERED\"",
  "keyword": "And "
});
formatter.match({
  "location": "Contract_Dispatcher.gettextconfirmationadd(String,String)"
