$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_DONA_B2B/PRE_PROD/Contract_Dispatcher_BUKALAPAK_B2B.feature");
formatter.feature({
  "name": "Contract Dispatcher for DONA BUKALAPAK B2B",
...
formatter.scenario({
  "name": "Select Menu Contract Dispatcher and Select Contract based on type contract DONA_BUKALAPAK_B2B",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "Verify Tab Matrix for \"DONA_BUKALAPAK_B2B\"",
  "keyword": "And "
});
formatter.match({
