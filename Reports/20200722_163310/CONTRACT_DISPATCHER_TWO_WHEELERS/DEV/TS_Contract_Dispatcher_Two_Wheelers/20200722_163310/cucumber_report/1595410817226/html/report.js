$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_TWO_WHEELERS/DEV/Pick_Mistake_Without_Write_Textarea_Note_Before.feature");
formatter.feature({
...
formatter.step({
  "name": "Choose Dropdown mistake type \"Upload Dokumen\" from mistake name \"KTP Foto Komponen Tidak Ada\"",
  "keyword": "And "
});
formatter.match({
