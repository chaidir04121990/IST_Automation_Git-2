$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_TWO_WHEELERS/DEV/Claim_Contract_Two_Wheelers_then_Save_it_Without_Register_Any_Mistakes.feature");
formatter.feature({
  "name": "Claim Contract Two Wheelers then Save it Without Register any Mistakes",
