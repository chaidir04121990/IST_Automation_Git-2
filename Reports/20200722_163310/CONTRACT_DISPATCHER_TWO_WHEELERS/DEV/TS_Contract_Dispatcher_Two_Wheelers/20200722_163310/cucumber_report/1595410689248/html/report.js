$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("/Users/chaidir.pratama01/Katalon Studio/IST_Automation_Git/Include/features/IST_Real/CONTRACT_DISPATCHER_TWO_WHEELERS/DEV/Pick_Mistake_Without_Write_Textarea_Note_After.feature");
formatter.feature({
  "name": "Pick Mistake Without Write Textarea Note_after",
...
formatter.scenario({
  "name": "Select Menu Contract Dispatcher and Select Contract based on type contract Two Wheelers EFP",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "Get text from pop up \"IT Supporting Tools\" with text \"Note-after cannot be empty\"",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "Comment \"Register Mistake failed because Note-after empty\"",
  "keyword": "And "
});
formatter.match({
