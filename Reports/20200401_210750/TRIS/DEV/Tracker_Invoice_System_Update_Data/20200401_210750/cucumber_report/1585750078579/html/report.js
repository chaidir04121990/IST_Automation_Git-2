...
formatter.result({
  "error_message": "Assertion failed: \n\nassert InSumPurpose \u003d\u003d AdPurpose\n       |            |  |\n       null         |  None\n                    false\n\r\n\tat org.codehaus.groovy.runtime.InvokerHelper.assertFailed(InvokerHelper.java:402)\r\n\tat org.codehaus.groovy.runtime.ScriptBytecodeAdapter.assertFailed(ScriptBytecodeAdapter.java:650)\r\n\tat ist_real.Contract_Dispatcher.updateAddDetail(Contract_Dispatcher.groovy:1863)\r\n\tat ✽.Verify Update Data in Additional Detail(C:/Users/ramsey.loloyanto/Documents/ist-Katalon/Include/features/IST_Real/TRIS/DEV/Tracker_Invoice_System_Update_Data.feature:42)\r\n",
  "status": "failed"
});
formatter.step({
...
formatter.result({
  "error_message": "Assertion failed: \n\nassert InSumPurpose \u003d\u003d AdPurpose\n       |            |  |\n       null         |  None\n                    false\n\r\n\tat org.codehaus.groovy.runtime.InvokerHelper.assertFailed(InvokerHelper.java:402)\r\n\tat org.codehaus.groovy.runtime.ScriptBytecodeAdapter.assertFailed(ScriptBytecodeAdapter.java:650)\r\n\tat ist_real.Contract_Dispatcher.updateAddDetail(Contract_Dispatcher.groovy:1863)\r\n\tat ✽.Verify Update Data in Additional Detail(C:/Users/ramsey.loloyanto/Documents/ist-Katalon/Include/features/IST_Real/TRIS/DEV/Tracker_Invoice_System_Update_Data.feature:65)\r\n",
  "status": "failed"
});
formatter.step({
  "name": "Click button \"Logout\"",
